        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          ...
          <div className="md:col-span-2 space-y-3">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/20 backdrop-blur-md text-xs font-bold tracking-wider uppercase">
              ...
              <span>小二英文單字記憶大冒險</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight leading-tight">
              嗨，座號 <span className="underline decoration-yellow-400">{userProfile.seatNumber}</span>！準備好闖關學習了嗎？
            </h1>
                ...
                {isUnlocked ? (
                  <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100">
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-indigo-50 hover:bg-indigo-600 text-indigo-700 hover:text-white text-xs font-bold transition-all flex items-center justify-center space-x-1"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-amber-50 hover:bg-amber-500 text-amber-800 hover:text-white text-xs font-bold transition-all flex items-center justify-center space-x-1"
                    >
                    ...
                    <button
                      onClick={() => {
                        soundSynth.playFlip();
                        onSelectLevel(levelId, 'spelling');
                      }}
                      className="px-3 py-2 rounded-xl bg-purple-50 hover:bg-purple-600 text-purple-700 hover:text-white text-xs font-bold transition-all flex items-center justify-center space-x-1"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-xl bg-emerald-50 hover:bg-emerald-600 text-emerald-700 hover:text-white text-xs font-bold transition-all flex items-center justify-center space-x-1"
                    >
